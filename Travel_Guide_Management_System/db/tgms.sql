...
INSERT INTO `guide` (`id`, `firstName`, `lastName`, `email`, `password`, `birthday`, `gender`, `contact`, `nid`, `address`, `dept`, `degree`, `pic`) VALUES
...
INSERT INTO `guide_leave` (`id`, `token`, `start`, `end`, `reason`, `status`) VALUES
...
INSERT INTO `work` (`pid`, `eid`, `pname`, `duedate`, `subdate`, `mark`, `status`) VALUES
