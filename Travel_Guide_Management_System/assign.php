...
<head>
    ...
    <!-- Title Page-->
    <title>Assign Work | Admin Panel |Travel guide Management System</title>
    ...
    <header>
        <nav>
            ...
            <ul id="navli">
                ...
                <li><a class="homered" href="assign.php">Assign Work</a></li>
                ...
                <div class="card-body">
                    ...
                    <form action="process/assignp.php" method="POST" enctype="multipart/form-data">
                         ...
                         <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Guide ID" name="eid" required="required">
                        </div>
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Destination Name" name="pname" required="required">
                        </div>
