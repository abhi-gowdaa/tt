...
<html>
<head>
	<title>Travel guides Panel | Travel guides Management System</title>
...
<body>
	...
	<header>
		<nav>
			<h1>Travel guides Management System</h1>
			<ul id="navli">
				<li><a class="homered" href="eloginwel.php?id=<?php echo $id?>"">HOME</a></li>
				<li><a class="homeblack" href="myprofile.php?id=<?php echo $id?>"">My Profile</a></li>
				<li><a class="homeblack" href="empproject.php?id=<?php echo $id?>"">My Work</a></li>
	...
	<div>
    	...
    	<h2 style="font-family: 'Montserrat', sans-serif; font-size: 25px; text-align: center;">Destination Due</h2>
